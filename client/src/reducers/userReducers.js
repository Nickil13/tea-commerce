...
import { USER_CART_ADD_ITEM_FAIL, USER_CART_ADD_ITEM_REQUEST, USER_CART_ADD_ITEM_RESET, USER_CART_ADD_ITEM_SUCCESS, USER_CART_CLEAR_ITEMS_FAIL, USER_CART_CLEAR_ITEMS_REQUEST, USER_CART_CLEAR_ITEMS_RESET, USER_CART_CLEAR_ITEMS_SUCCESS, USER_CART_REMOVE_ITEM_FAIL, USER_CART_REMOVE_ITEM_REQUEST, USER_CART_REMOVE_ITEM_RESET, USER_CART_REMOVE_ITEM_SUCCESS, USER_CART_SAVE_PAYMENT_METHOD, USER_CART_UPDATE_QUANTITY_FAIL, USER_CART_UPDATE_QUANTITY_REQUEST, USER_CART_UPDATE_QUANTITY_RESET, USER_CART_UPDATE_QUANTITY_SUCCESS, DELETE_USER_FAIL, DELETE_USER_REQUEST, DELETE_USER_SUCCESS, GET_USER_PROFILE_FAIL, GET_USER_PROFILE_REQUEST, GET_USER_PROFILE_RESET, GET_USER_PROFILE_SUCCESS, LIST_USERS_FAIL, LIST_USERS_REQUEST, LIST_USERS_SUCCESS, UPDATE_USER_FAIL, UPDATE_USER_PROFILE_FAIL, UPDATE_USER_PROFILE_REQUEST, UPDATE_USER_PROFILE_RESET, UPDATE_USER_PROFILE_SUCCESS, UPDATE_USER_REQUEST, UPDATE_USER_RESET, UPDATE_USER_SUCCESS, USER_DETAILS_FAIL, USER_DETAILS_REQUEST, USER_DETAILS_SUCCESS, USER_LOGIN_FAIL, USER_LOGIN_REQUEST, USER_LOGIN_SUCCESS, USER_REGISTER_FAIL, USER_REGISTER_REQUEST, USER_REGISTER_SUCCESS, WISHLIST_ADD_ITEM_FAIL, WISHLIST_ADD_ITEM_REQUEST, WISHLIST_ADD_ITEM_RESET, WISHLIST_ADD_ITEM_SUCCESS, WISHLIST_REMOVE_ITEM_FAIL, WISHLIST_REMOVE_ITEM_REQUEST, WISHLIST_REMOVE_ITEM_SUCCESS, USER_REGISTER_RESET, USER_DETAILS_RESET, IS_USER_LOGIN_REQUEST, IS_USER_LOGIN_SUCCESS, IS_USER_LOGIN_FAIL, USER_LOGOUT_REQUEST, USER_LOGOUT_SUCCESS, USER_LOGOUT_FAIL} from "../constants/userConstants";
...
const isUserLoggedInReducer = (state = { }, action) => {
    switch(action.type){
        case IS_USER_LOGIN_REQUEST:
            return { loading: true}

        case IS_USER_LOGIN_SUCCESS:
            return { loading: false, user:action.payload}
        
        case IS_USER_LOGIN_FAIL:
            return { loading: false, error: action.payload}
...
export const userReducer = combineReducers({
    ...
    userLoggedOut : userLogoutReducer,
