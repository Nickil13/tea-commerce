    ...
    return (
        <article className="cart-card">
            <div className="img-container">
                <Link to={`/shop/${category}/${productType}/${_id}`}>
            ...
            <div className="cart-card-description">
                ...
                <div onClick={handleRemoveClick} className="remove-item-btn">
                    <VscClose />
                    <span>remove</span>
                </div>
                <div className="cart-card-total">
                    <p>
                        total: <strong>${total}</strong> | {quantity * 50}g
                    </p>
                </div>
            </div>
        </article>
